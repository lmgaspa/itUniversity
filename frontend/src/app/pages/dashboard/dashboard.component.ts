...
export class DashboardComponent implements OnInit {
  ...
  private fetchCourses(): void {
    this.http
      .get<any[]>('https://ituniversity-0ba72c28fb77.herokuapp.com//api/v1/courses/find-all-courses')
      .subscribe({
        next: (data) => {
          this.courses = data;
  ...
  private fetchEnrolledCourses(): void {
    this.http
      .get<any[]>(`https://ituniversity-0ba72c28fb77.herokuapp.com//api/v1/enrollments/enroll/user/${this.userId}`)
      .subscribe({
        next: (data) => {
  ...
  confirmFormationEnrollment(): void {
    ...
    this.http
      .post('https://ituniversity-0ba72c28fb77.herokuapp.com//api/v1/enrollments/enroll', payload, {
