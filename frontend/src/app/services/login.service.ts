...
export class LoginService {
  private readonly apiUrl: string = 'http://168.75.95.105:8081/api/v1/auth';
  ...
  getAllUsers() {
    return this.httpClient.get<any[]>('http://168.75.95.105:8081/api/v1/user/find-all-users').pipe(
